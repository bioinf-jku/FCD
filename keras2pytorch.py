...
def convert_LSTM_layer(keras_layer):
    pytorch_config = {
        "input_size": keras_layer.input.shape[-1],
        "hidden_size": keras_layer.output.shape[-1],
        "batch_first": True,
    }
...
def convert_Conv1d_layer(keras_layer):
    ...
    pytorch_config = {
        "in_channels": keras_layer.input.shape[-1],
        "out_channels": keras_layer.output.shape[-1],
